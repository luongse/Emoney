...
namespace BusinessObject.WalletBusiness.Enums
{
    ...
    public enum WHelperDetailStatusCode
    {
        ...
        [Description(" Get exchange money info  Http status is not Ok")]
        EmoneyGetExchangeMoneyInfoHttpStatusNotOk = 119,

        [Description("Get exchange money info parse data null")]
        EmoneyExchangeMoneyInfoParseDataNull = 120,

        [Description("Response string Exchange EmoneyInfo response with isSuccess: false ")]
        EmoneyExchangeMoneyInfoResponseFromEmoneyFail = 121,


        [Description("Get exchange money info convert data null")]
        EmoneyExchangeMoneyInfoConvertDataNull = 122,

        [Description("Exchange money info response generate transactionId null")]
        ExchangeMoneyInfoGenTransIdEmpty = 123,


        [Description("Exchange Money empty response")]
        EmoneyExchangeMoneyEmptyResponse = 124,

        [Description("Exchange money  Http status is not Ok")]
        EmoneyConfirmExchangeMoneyHttpStatusNotOk = 125,

        [Description("Confirm exchange money parse data null")]
        EmoneyConfirmExchangemoneyParseDataNull = 126,

        [Description("Response string confirm exchange emoney  response with isSuccess: false ")]
        EmoneyConfirmExchangeMoneyResponseFromEmoneyFail = 127,

        [Description("Confirm exchange money convert data null")]
        EmoneyConfirmExchangeMoneyConvertDataNull = 128,


        [Description("Emoney eneral fail exception")]
        EmoneyGeneralFailException = 129,

        [Description("Emoney eneral fail exception")]
        EmoneyAccountNotFound = 130,

        [Description("Get top up bill info empty response")]
        GetTopUpBillInfoResponseEmpty = 131,

        [Description("Get top up bill info Http status is not OK")]
        GetTopUpBillInfoHttpStatusNotOK = 132,

        [Description("Get top up bill info parse data null")]
        GetTopUpBillInfoParseDataNull = 133,


        [Description("Get top up info convert data null")]
        EmoneyTopUpInfoConvertDataNull = 134,

        [Description("Confirm top up money empty response")]
        EmoneyConfirmTopUpEmptyResponse = 135,

        [Description("Confirm top up money Http status is not OK")]
        EmoneyConfirmTopUpHttpStatusNotOK = 136,

        [Description("Confirm top up money parse data null")]
        EmoneyConfirmTopUpParseDataNull = 137,


        [Description("Confirm top up money convert data null")]
        EmoneyConfirmTopUpConvertDataNull = 138,

        [Description("TopUp info response generate transactionId null")]
        TopUpInfoGenTransIdEmpty = 139,
